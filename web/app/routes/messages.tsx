...
import { conversationCollection, usersCollection, messagesCollection } from '~/lib/firebase/collections';
...
export default function Messages() {
  ...
  const handleUserSelect = async (selectedUser: User) => {
    ...
    try {
      ...
      setSearchParams({ user: selectedUser.id });
      ...
      return (
        <div className='flex w-full h-screen'>
          <MainContainer className='w-full flex flex-col min-h-screen'>
            <MainHeader useActionButton title='Messages' action={() => navigate(-1)}>
              <Button
      ...
      <div className='flex w-full h-screen flex-col'>
        ...
        <div className='flex-shrink-0 bg-main-background border-b border-light-border dark:border-dark-border p-4'>
          <div className='flex items-center gap-3'>
            ...
            <Link to={`/user/${targetUser.username}`}>
